...
function ReportByDept() {
    ...
    const handleReport= (e) => {
        ...
        e.preventDefault();
        Axios.get("http://localhost:3001/getReportByMedical",{
            params: {
                medical: medical,
                startDate: startDate,
                endDate: endDate
    ...
    return (
        <div className="report">
            ...
            <h1 className="reportTitle mb-4">Report By Medical</h1>
            ...
            table="reportByMedical" filename="ReportbyMedicalType" sheet="Sheet" buttonText="Export to Excel"/>
            <h3 className="reportTitle mb-4">Report Details</h3>
                <table className="reportTable" id="reportByMedical">
                    <thead>
                        <tr>
