...
function ClinicTransaction() {
    ...
    //     e.preventDefault();
    //     // let empObj = JSON.parse(empObject);
    ...
    const validate = () => {
        ...
        if (!cost){
            errors.cost = "Transaction Charge is required!";
        }else if(cost < 0){errors.cost = "Transaction Charge must be positive";}
    ...
    <div className="adminTransaction">
        ...
        <h3 className="adminTransactionTitle">Transaction</h3>
            <div className="addItem">
                ...
                <InputForm type="number" cId="" 
                    label="Charge:" placeholder="Charge in RM"
                    onChange={(event) =>{
                    setCost(event.target.value);
                }}/>
                <p className="errorText text-center">{formErrors.cost}</p>
